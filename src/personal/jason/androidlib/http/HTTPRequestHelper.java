...
import personal.jason.androidlib.utils.StringUtils;
 ...
 * 
 * 详细使用demo见 personal.jason.androidlib.demo.http.HTTPRequestHelperDemo
 * 
 * @author vb.wbw
 * @create 2010.11.08
 * 
...
public class HTTPRequestHelper {
	...
	/**
	 * as Should handle the HTTP use one object in fancy W-Map we set the get
	 * method
	 */
	...
	public static ResponseHandler<String> getResponseHandlerInstance(
		...
		final ResponseHandler<String> responseHandler = new ResponseHandler<String>() {
			...
			public String handleResponse(final HttpResponse response) {
				...
				if (entity != null) {
					try {
						result = StringUtils.inputStreamToString(entity
								.getContent());
